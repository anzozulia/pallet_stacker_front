...
Last activity: 2026-06-17 - Completed quick task 260617-w8a: demo box-catalog presets (4 API-vetted, pickable on Configure page)
...
| 260617-w8a | Demo box-catalog presets pickable atop Configure page (form.reset prefill; fixed pallet 1200×800×1800/1000kg, only boxes vary). Presets revised to 3 API-vetted NON-OBVIOUS interlocking catalogs (large-unit+2-fillers 2pal; 900+300 forced length-pairing 4pal; 1200×500+1200×300 width-pairing 3pal) — the initial uniform-grid set was rejected as trivial | 2026-06-17 | e08010a | Verified (code; 224 tests + live-API placement checks) | [260617-w8a](./quick/260617-w8a-add-demo-box-catalog-presets-pickable-at/) |
